...
- [第 02 回 04月19日](2024ai_lect02): 人工知能概説，チューリングテスト，中国語の部屋，歴史，ダートマス会議，AIの冬。線形代数の基礎
- [第 03 回 04月26日](2024ai_lect03): 機械学習(1)。東京技術計算コンサルタント様ピッチ。オリベッティ顔データベースを用いたロジスティック回帰。<!--確率論，回帰と分類，教師あり学習，データセットの種類，交差検証。Naive Bayes, AdaBoost, Nearest Neighbors, sklearn-->
- 05 月 03 日: 健康記念日 休講
...
- [第 05 回 05月17日](2024ai_lect05): 機械学習(3)。記号接地問題，中国語の部屋。線形代数の基本。回帰を題材に。F 分布と分散の分解定理。openCV による顔領域の切り出し，矩形回帰。<!--サポートベクターマシン，ランダムフォレスト，最近傍法-->
- [第 06 回 05月24日](2024ai_lect06): 機械学習(4) Eigenfaces versus Fisherfaces, ランダムフォレスト，リッジ回帰，ラッソ回帰，エラスティック回帰<!--教師なし学習，PCA，SVD, NMF, 自己組織化，インフォマックス基準，Kohonen SOM,-->
- 第 07 回 05月31日: 機械学習(5) ナイーブベイズ，TFIDF, AdaBoost <!--(`~/study/2024notebooks/2021_0930viola_jones.ipynb`)-->
