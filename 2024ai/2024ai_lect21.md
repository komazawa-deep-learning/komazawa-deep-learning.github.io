...
<!-- * [オノマトペ関連 <img src="/assets/colab_icon.svg">](https://colab.research.google.com/github/project-ccap/project-ccap.github.io/blob/master/2023notebooks/2023_1115onomatope_generator.ipynb){:target="_blank"} -->
...
一方，ソフトパラメータ共有では，各タスクが独自のパラメータを持つ独自のモデルを持つ。
モデルのパラメータ間の距離は，パラメータが類似するように正則化される。[8]
などは正則化に$l2$ノルムを用い，[9]はトレースノルムを用いる。
