...
- [第18回 10月10日](2025ai_lect18){:target="_blank"}: リカレントニューラルネットワーク, ワンホットベクトル，埋め込みベクトル
- [第19回 10月17日](2025ai_lect19){:target="_blank"}: LSTM, word2vec, LDA, LSI, SVD，トピックモデル，意味記憶<!--自然言語処理 (4) 符号化器・復号化器モデル，翻訳モデル，注意-->
- [第20回 10月24日](2025ai_lect20){:target="_blank"}: 自然言語処理 (5) Transformer, マルチヘッド多頭注意, BERT, GLUE, GPT
- [第21回 11月14日](2025ai_lect21){:target="_blank"}: 自然言語処理 (6) 視覚と言語との融合。NIC, VQA
