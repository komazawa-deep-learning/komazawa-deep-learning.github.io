...
<!-- - [第 08 回 06月13日](2025ai_lect08){:target="_blank"}: ニューラルネットワーク(1) パーセプトロン，パンデモニアムモデル 初期視覚特徴，HOG，SIFT, ガウシアンピラミッド，ラプラシアンピラミッド，ヒューベルとウィーゼルの生理実験 -->
...
- [第 13 回 07月18日](2025ai_lect13){:target="_blank"}: ニューラルネットワーク(6) 画風変換，蒸留，ファインチューニング，転移学習，医療画像診断，変分自己符号化器，生成敵対ネットワーク，ゲーム理論，ナッシュ均衡

# 後期予定

- [第15回 09月19日](2025ai_lect15){:target="_blank"}: イントロダクション，前期の復習，FFT，生成 AI，画像生成，拡散モデル，
- [第16回 09月26日](2025ai_lect16){:target="_blank"}: トークナイザ，自己相関，自己相関和分移動平均モデル，フーリエ変換<!--自然言語処理 (1) 言語モデル，言語処理課題，単純再帰型ニューラルネットワーク:Elman and Jordan, BPTT, 系列学習-->
- [第17回 10月03日](2025ai_lect17){:target="_blank"}: カルマンフィルタ，<!--自然言語処理 (2) 翻訳モデル: LSTM ゲート-->
- [第18回 10月10日](2025ai_lect18){:target="_blank"}: リカレントニューラルネットワーク, 
- [第19回 10月17日](2025ai_lect19){:target="_blank"}: LSTM, 埋め込みベクトル<!--自然言語処理 (4) 符号化器・復号化器モデル，翻訳モデル，注意-->
- [第20回 10月24日](2025ai_lect20){:target="_blank"}: word2vec, ワンホットベクトル，単語埋め込み表現, 
- [第21回 11月07日](2025ai_lect21){:target="_blank"}: Transformer, LDA, LSI, SVD，トピックモデル，意味記憶, マルチヘッド多頭注意, BERT, GLUE, GPT<!--自然言語処理 (6) 視覚と言語との融合。NIC, VQA-->
- [第22回 11月14日](2025ai_lect22){:target="_blank"}: RAG
...
- [第25回 12月05日](2025ai_lect25){:target="_blank"}: 強化学習 (3) エージェント 57，二重 DQN，経験再生，エピソード記憶，方策反復，優先付き再生，経験再生，A3C，エージェント57
- [第26回 12月12日](2025ai_lect26){:target="_blank"}: 強化学習 (4) エージェント 57 の続き，短期記憶，内発的動機づけ，エピソード記憶
- 第27回 12月19日: 強化学習のまとめ，世界モデル，メタ学習，少事例学習，一撃学習
- 第28回 01月09日
