...
- [第17回 10月03日](2025ai_lect17){:target="_blank"}: カルマンフィルタ，リカレントニューラルネットワーク<!--自然言語処理 (2) 翻訳モデル: LSTM ゲート-->
- [第18回 10月10日](2025ai_lect18){:target="_blank"}: 自然言語処理 (1) 意味モデル: word2vec, LDA, LSI, SVD，トピックモデル，意味記憶
