...
- [第 11 回 07月04日](2025ai_lect11){:target="_blank"}: ニューラルネットワーク(4) AlexNet, VGG, ResNet, Inception, DenseNet, ドロップアウト, 
- 第 12 回 07月11日: ニューラルネットワーク(5) 領域分割と物体認識，特徴ピラミッドネットワーク，スキップ結合，ソフトマックス関数, 視覚野の結線 (van Essen), CAM，注意，転移学習，微調整，蒸留
