...
* [課題提出用フォルダ <img src="/2025assets/Google_Drive_icon_2020.svg" style="width:02%">](https://drive.google.com/drive/folders/1PbM65pDtkZz_eHsNgHhUHTfvqmR2xr2r){:target="_blank"}
...
* [最小コードの排他的論理和  <img src="/assets/colab_icon.svg">](https://colab.research.google.com/github/komazawa-deep-learning/komazawa-deep-learning.github.io/blob/master/notebooks/220komazawa_miniumXOR.ipynb){:target="_blank"}, XOR を独自コードで解く。加えて，SVM, Random Forest, Logistic 回帰なども試す。
...
* 正則化，正規化，標準化
regularization 正則化, normalization 標準化, standardization 正規化
