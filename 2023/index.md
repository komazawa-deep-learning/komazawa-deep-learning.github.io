...
- 第22回 11月03日: Transfer leanring, 視覚と言語の融合 Stroop 効果 <!--注意，トランスフォーマー。自然言語処理における注意を学びます。注意の導入がゲームチェンジャーとなりました。なぜ，注意が必要となったのかについては，分野を越えて議論が可能です。キーワード：マルチヘッド自己注意，位置符号化器，マスク化言語モデル，要約，極性判断-->
- 第23回 11月10日: 半側空間無視
- 第24回 11月17日: 三角モデル (視覚, 意味, 音韻), DRC モデル, 失語症のモデル<!-- キーワード：単語読字モデル，音韻失読，意味失読，語彙判断課題，音読課題，絵画命名課題，ピラミッド・ヤシの木検査, 大規模言語モデル。 BERT とその発展モデルについて取り上げます。多くのモデルが提案されており，精度も向上しています。取り上げるモデルでは何がポイントかを議論します。加えて，言語習得，語彙発達，語彙爆発と言った発達心理学の話題に触れ，これらの現象のモデルを考察します。キーワード：BERT, GPT1, GPT2, GPT3, GLUE, chatGPT-->
- 第25回 11月24日: 幾何学的錯視, 視覚生成モデル <!-- 画像と言語の融合。マルチモーダル統合について，最近の発展を踏まえて議論します。キーワード：DALL-E, 脚注付け, NIC, VQA，マガーク効果，ゴムの手錯視，身体パラフレニア-->
