...
- 第24回 11月24日: 三角モデル (視覚, 意味, 音韻), DRC モデル, 失語症のモデル<!-- キーワード：単語読字モデル，音韻失読，意味失読，語彙判断課題，音読課題，絵画命名課題，ピラミッド・ヤシの木検査, 大規模言語モデル。 BERT とその発展モデルについて取り上げます。多くのモデルが提案されており，精度も向上しています。取り上げるモデルでは何がポイントかを議論します。加えて，言語習得，語彙発達，語彙爆発と言った発達心理学の話題に触れ，これらの現象のモデルを考察します。キーワード：BERT, GPT1, GPT2, GPT3, GLUE, chatGPT-->
