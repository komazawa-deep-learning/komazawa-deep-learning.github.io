...
- [第 02 回 04月21日](2023lect02): 人工知能とは何か。人工知能の歴史を概説します。
...
- [第 04 回 05月06日](2023lect04): 機械学習(2) 課題授業 (5月5日を予定)
基本的なモデルの選択基準，評価方法並びに評価指標を学びます。
- [第 05 回 05月05日](2023lect05): ニューラルネットワーク。
キーワード：パーセプトロン，パンデモニアムモデル，入力層，中間層，出力層，重み係数，しきい値，活性化関数，
- [第 06 回 05月12日](2023lect06): ディープニューラルネットワーク(1)
キーワード： ハイパータンジェント関数，線形整流化関数，損失関数，誤差逆伝播法，勾配消失問題
- [第 07 回 05月19日](2023lect07): ディープニューラルネットワーク(2)
キーワード：畳み込み，ストライド，カーネル幅，パディング，プーリング，全結合層，ネオコグニトロン，LeNet
- [第 08 回 05月26日](2023lect08): ディープニューラルネットワークにおける画像認識と人間の視覚情報処理の関係
キーワード：畳み込み，初期視覚特徴，HOG，SIFT, ガウシアンピラミッド，ラプラシアンピラミッド，オン中心-オフ周辺細胞，単純細胞，複雑細胞
- [第 09 回 06月02日](2023lect09): 機械学習における正則化と標準正則化理論 および生理学的対応物
キーワード： 計算論，視覚情報処理，標準正則化理論。ドロップアウト，スキップコネクト，ソフトマックス関数,LeNet, Inception, ResNet, MHnet, EfficientNet。視覚野の結合。
- [第 10 回 06月09日](2023lect10): 領域分割と物体認識
キーワード：物体切り分け，意味的切り分け，腹側経路，背側経路
- [第 11 回 06月16日](2023lect11): 転移学習と微調整(ファインチューニング)
キーワード：データ拡張，半教師あり学習，蒸留，医療画像診断
- [第 12 回 06月23日](2023lect12): 人間の視覚情報処理と機械の画像認識。古典的錯視を例に，人間の視覚情報処理と機械の画像認識との相違について議論します。
- [第 13 回 07月07日](2023lect13): 顔認識と文字認識とその障害。相貌失認，失読症，顔認知 シャッフル顔，サッチャー錯視。
- [第 14 回 07月14日](2023lect14): 注意機構と特徴統合理論。
キーワード：視覚探索，ソフトマックス，CAM，ブロードベント，ポズナー，トリーズマン，コッホ
- [第 15 回 07月21日](2023lect15): フェイク画像の生成，画風変換。
キーワード: GAN (生成敵対モデル)，変分自己符号化器モデル
<!-- - [定期試験 07月28日](2023exam): -->

### 後期予定

- [第16回 09月22日](2023lect16): メタ学習，少事例学習，一撃学習。ビッグデータと学習によって支えられている大規模モデルを発展させるため，あるいは社会応用のためにも重要が概念を取り上げます。
- [第17回 09月29日](2023lect17): 自然言語処理。AI 分野での言語処理モデルを扱う，自然言語処理を紹介します。自然言語処理と言語心理学，心理言語学，言語学と言った関連分野との繋がりについて考えます。
キーワード： 言語モデル，言語処理課題，文法，意味，統語
- [第18回 10月06日](2023lect18): 単純再帰型ニューラルネットワーク。系列情報処理モデルでもあるリカレントニューラルネットワークを導入します。
キーワード: エルマンネット，ジョーダンネット，BPTT，系列学習，勾配爆発問題
- [第19回 10月13日](2023lect19): 意味モデル。ニューラルネットワークによる意味表現を取り上げます。心理学においても意味を扱うことがありますが，心理学とニューラルネットワークとで，意味の相違を考え，意味モデルの心理学への応用を考えます。
