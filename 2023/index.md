...
- [第 02 回 04月21日](2023lect02): GPT <!--人工知能とは何か。人工知能の歴史。機械学習の考え方 キーワード: チューリングテスト，知識表現，エキスパートシステム，意味ネット，第 3 次 AI ブーム，AI の冬-->
...
- 第 07 回 05月26日: 休講 <!--ディープニューラルネットワーク(2)-->
...
- [第 10 回 06月16日](2023lect10): <!--領域分割と物体認識 キーワード：物体切り分け，意味的切り分け，腹側経路，背側経路-->
- [第 11 回 06月23日](2023lect11): <!--転移学習と微調整(ファインチューニング)-->
<!--キーワード：データ拡張，半教師あり学習，蒸留，医療画像診断-->
- [第 12 回 06月30日](2023lect12): 人間の視覚情報処理と機械の画像認識。畳み込み演算，最大値プーリング
<!-- - 古典的錯視を例に，人間の視覚情報処理と機械の画像認識との相違について議論します。スキップ結合，-->
- [第 13 回 07月07日](2023lect13): <!--顔認識と文字認識とその障害。相貌失認，失読症，顔認知 シャッフル顔，サッチャー錯視-->
- [第 14 回 07月14日](2023lect14): diffusion model,  <!-- - 注意機構と特徴統合理論。キーワード：視覚探索，ソフトマックス，CAM，ブロードベント，ポズナー，トリーズマン，コッホ -->
- [第 15 回 07月21日](2023lect15): ファインチューニング，転移学習 <!--フェイク画像の生成，画風変換。-->
...
- [第16回 09月22日](2023lect16): 後期授業についてのイントロダクション <!--メタ学習，少事例学習，一撃学習。ビッグデータと学習によって支えられている大規模モデルを発展させるため，あるいは社会応用のためにも重要が概念を取り上げます。-->
- [第17回 09月29日](2023lect17): ニューラルネットワークの復習 <!-- Dataset, Train, val, test dataset, loss, optim 自然言語処理。AI 分野での言語処理モデルを扱う，自然言語処理を紹介します。自然言語処理と言語心理学，心理言語学，言語学と言った関連分野との繋がりについて考えます。キーワード： 言語モデル，言語処理課題，文法，意味，統語-->
- [第18回 10月06日](2023lect18){:target="_blank"}: CNN <!-- 転移学習と微調整 TLPA, SALA, PNT, Snodgrass&Vanderwart1980, 文字認識 , 単純再帰型ニューラルネットワーク。系列情報処理モデルでもあるリカレントニューラルネットワークを導入します。キーワード: エルマンネット，ジョーダンネット，BPTT，系列学習，勾配爆発問題-->
- [第19回 10月13日](2023lect19){:target="_blank"}: R-CNN, DETR, <!-- > 位置情報と形態情報 R-CNN, DETR,  意味モデル。ニューラルネットワークによる意味表現を取り上げます。心理学においても意味を扱うことがありますが，心理学とニューラルネットワークとで，意味の相違を考え，意味モデルの心理学への応用を考えます。キーワード： 単語埋め込みモデル，word2vec, LDA, トピックモデル，意味記憶，BoW，-->
- [第20回 10月20日](2023lect20){:target="_blank"}: CAM, 視覚的注意<!--LSTM。ゲート機構の導入。言語モデルの発展を紹介します。言語モデルの性能向上を目指して，注意が導入されました。このことは後のトランスフォーマーに直接関係します。LSTM の心理学的意味合いを考えます。LSTM のゲートの役割は，短期記憶の保持とも関連します。短期記憶における系列位置曲線を再現するモデルを紹介します。キーワード：入力，出力，忘却ゲート，状態遷移，単語ベースと文字ベースの言語モデル-->
- [第21回 10月27日](2023lect21){:target="_blank"}: Enocder-decodder, NIC, 注意符号化器‐復号化器モデル ，IA，Dell model <!--翻訳モデル。翻訳モデルを実習します。キーワード: 符号化器-復号化器モデル，系列対系列 (seq2seq) モデル，語彙，POS-->
- [第22回 11月10日](2023lect22){:target="_blank"}: Transfer leanring, 視覚と言語の融合 Stroop 効果 <!--注意，トランスフォーマー。自然言語処理における注意を学びます。注意の導入がゲームチェンジャーとなりました。なぜ，注意が必要となったのかについては，分野を越えて議論が可能です。キーワード：マルチヘッド自己注意，位置符号化器，マスク化言語モデル，要約，極性判断-->
- [第23回 11月17日](2023lect23){:target="_blank"}: 半側空間無視
- [第24回 11月24日](2023lect24){:target="_blank"}: 三角モデル (視覚, 意味, 音韻), DRC モデル, 失語症のモデル<!-- キーワード：単語読字モデル，音韻失読，意味失読，語彙判断課題，音読課題，絵画命名課題，ピラミッド・ヤシの木検査, 大規模言語モデル。 BERT とその発展モデルについて取り上げます。多くのモデルが提案されており，精度も向上しています。取り上げるモデルでは何がポイントかを議論します。加えて，言語習得，語彙発達，語彙爆発と言った発達心理学の話題に触れ，これらの現象のモデルを考察します。キーワード：BERT, GPT1, GPT2, GPT3, GLUE, chatGPT-->
- [第25回 12月01日](2023lect25){:target="_blank"}: 幾何学的錯視, 視覚生成モデル <!-- 画像と言語の融合。マルチモーダル統合について，最近の発展を踏まえて議論します。キーワード：DALL-E, 脚注付け, NIC, VQA，マガーク効果，ゴムの手錯視，身体パラフレニア-->
- [第26回 12月08日](2023lect26): 強化学習 (1) 強化学習の基本概念。
強化学習の基本を解説し，心理学，経済学における強化学習との比較を試みます。
キーワード: 報酬，価値，TD 誤差，方策，イプシロン貪欲探索，，マルコフ決定過程
- [第27回 12月15日](2023lect27): 強化学習(2) アタリのゲーム AI で人間越えした DQN とアルファ碁。
...
- [第28回 12月22日](2023lect28): 強化学習(3) アタリの全ゲームで人間越えした最近の発展。
...
- [第29回 01月05日](2023lect29): 精神医学と世界モデル。人工知能と精神医学，臨床心理学との関係について議論します。
キーワード：自由エネルギー原理
<!-- - 第30回 01月05日: 総まとめ -->
