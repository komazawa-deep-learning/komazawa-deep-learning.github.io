...
- 第18回 10月06日: 転移学習と微調整 TLPA, SALA, PNT, Snodgrass&Vanderwart1980, 文字認識<!--単純再帰型ニューラルネットワーク。系列情報処理モデルでもあるリカレントニューラルネットワークを導入します。キーワード: エルマンネット，ジョーダンネット，BPTT，系列学習，勾配爆発問題-->
- 第19回 10月13日: 位置情報と形態情報 R-CNN, DETR <!--意味モデル。ニューラルネットワークによる意味表現を取り上げます。心理学においても意味を扱うことがありますが，心理学とニューラルネットワークとで，意味の相違を考え，意味モデルの心理学への応用を考えます。キーワード： 単語埋め込みモデル，word2vec, LDA, トピックモデル，意味記憶，BoW，-->
- 第20回 10月20日: 視覚的注意<!--LSTM。ゲート機構の導入。言語モデルの発展を紹介します。言語モデルの性能向上を目指して，注意が導入されました。このことは後のトランスフォーマーに直接関係します。LSTM の心理学的意味合いを考えます。LSTM のゲートの役割は，短期記憶の保持とも関連します。短期記憶における系列位置曲線を再現するモデルを紹介します。キーワード：入力，出力，忘却ゲート，状態遷移，単語ベースと文字ベースの言語モデル-->
- 第21回 10月27日: 注意符号化器‐復号化器モデル ，IA，Dell model <!--翻訳モデル。翻訳モデルを実習します。キーワード: 符号化器-復号化器モデル，系列対系列 (seq2seq) モデル，語彙，POS-->
- 第22回 11月10日: 視覚と言語の融合 Stroop 効果，幾何学的錯視 <!--注意，トランスフォーマー。自然言語処理における注意を学びます。注意の導入がゲームチェンジャーとなりました。なぜ，注意が必要となったのかについては，分野を越えて議論が可能です。キーワード：マルチヘッド自己注意，位置符号化器，マスク化言語モデル，要約，極性判断-->
- 第23回 11月17日: 視覚，意味，音韻 三角モデル DRC モデル<!-- 大規模言語モデル。 BERT とその発展モデルについて取り上げます。多くのモデルが提案されており，精度も向上しています。取り上げるモデルでは何がポイントかを議論します。加えて，言語習得，語彙発達，語彙爆発と言った発達心理学の話題に触れ，これらの現象のモデルを考察します。キーワード：BERT, GPT1, GPT2, GPT3, GLUE, chatGPT-->
- 第24回 11月24日: 視覚生成モデル <!-- 画像と言語の融合。マルチモーダル統合について，最近の発展を踏まえて議論します。キーワード：DALL-E, 脚注付け, NIC, VQA，マガーク効果，ゴムの手錯視，身体パラフレニア-->
- 第25回 12月01日: 失語症のモデル。
