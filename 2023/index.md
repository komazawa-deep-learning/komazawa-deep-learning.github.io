...
- 第19回 10月13日: R-CNN, DETR, <!-- > 位置情報と形態情報 R-CNN, DETR,  意味モデル。ニューラルネットワークによる意味表現を取り上げます。心理学においても意味を扱うことがありますが，心理学とニューラルネットワークとで，意味の相違を考え，意味モデルの心理学への応用を考えます。キーワード： 単語埋め込みモデル，word2vec, LDA, トピックモデル，意味記憶，BoW，-->
