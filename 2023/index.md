...
- 第20回 10月20日: CAM, 視覚的注意<!--LSTM。ゲート機構の導入。言語モデルの発展を紹介します。言語モデルの性能向上を目指して，注意が導入されました。このことは後のトランスフォーマーに直接関係します。LSTM の心理学的意味合いを考えます。LSTM のゲートの役割は，短期記憶の保持とも関連します。短期記憶における系列位置曲線を再現するモデルを紹介します。キーワード：入力，出力，忘却ゲート，状態遷移，単語ベースと文字ベースの言語モデル-->
