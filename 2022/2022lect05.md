...
- [本日の実習 <img src="/assets/colab_icon.svg">](https://colab.research.google.com/github/komazawa-deep-learning/komazawa-deep-learning.github.io/blob/master/2022notebooks/2022_0512logistic_regression_and_MLP_demo.ipynb)
...
あるいは，Mitchell と Just の研究室で行われている研究があります。
...
especially left temporal region (L = left, R = right).--></div>
</center>
...
<center>
<img src="/assets/17VISIOn-slide-WBE2-jumbo.jpg" style="width:88%"><br/>
