...
### <a name="mnist">3 つのデータセット: MNIST, Fashion MNIST, KMNIST</a> 
...
### <a name="dataset">訓練データ，テストデータ，検証データ</a>
...
### <a name="precision">モデルの精度を測る指標</a>
...
<a name="supervised_vs_unsupervised"></a>
## [教師あり学習と教師なし学習](#supervised_vs_unsupervised)
