...
- [次元圧縮 t-SNE](../t-SNE/){target="_blank"}
- [データサイエンス小史](../data_science/){target="_blank"}
- [数式の読み方](../how_to_read_math/){target="_blank"}
- 苦い教訓
    - [Sutton のブログ，苦い教訓](../2019Sutton_Bitter_Lesson/) <!--(../2019sutton_bitter_Lesson.pdf)-->
    - オリジナル Sutton's blog [bitter lesson](http://www.incompleteideas.net/IncIdeas/BitterLesson.html)
...
# 実習
- [もう少し詳しくステップバイステップで画像認識](https://github.com/komazawa-deep-learning/komazawa-deep-learning.github.io/blob/master/notebooks/2020_0515komazawa_step_by_step_CNN_Pytorch.ipynb){target="_blank"}
- [第一層目の視覚化](https://github.com/komazawa-deep-learning/komazawa-deep-learning.github.io/blob/master/notebooks/2020_0514komazawa_visualise_first_layers.ipynb){target="_blank"} - 視覚特徴の視覚化。
[ガボールパッチ あるいは ガボールフィルタ](../gabor_filter/){target="_blank"} とか，色ブロッブ。
...
<div align="center">
 ...
 <img src="../assets/1988Sur_Fig1lower.svg" style="width:44%">
 <img src="../assets/1988Sur_fig2.jpg" style="width:74%"><br/>
  <div align="left">
...
ドットで示されている）MG "MGdでは逆行性に、MGvでは後遺症複合体の側方分裂（P01）が行われている。MGdとMGvの多くの細胞が網膜突起帯を覆っている。 
 ...
 <img src="../assets/1988Sur_Fig4.svg" style="width:74%"><br/>
</div>
...
<div align="center">
<img src="../assets/HistoryOfObjectRecognition_head.svg" style="wdith:94%">
</div>
...
<div align="center" style="width:94%">
  <img src="../assets/cnn/stride.jpeg"><br/>
...
<div align="center" style="width:88%">
  <img src="../assets/cnn/weights.jpeg" style="width:94%"><br/>
...
<div align="center">
  <img src="../assets/cnn/maxpool.jpeg" width="74%"><br/>
<div align="left">
...
<center>
<div>
  <img src="../assets/cnn/pool.jpeg" width="74%"><br/>
<div>
...
<div align="center">
<img src="../assets/2020Lillicrap_fig7.svg" style="width:94%"><br/>
Lillicrap et al. (2020) Fig. 7 を改変
</div>

- [video by Geoffrey Hinton](https://www.youtube.com/watch?v=mlaLLQofmR8) on the softmax function
- [A Friendly Introduction to Cross Entropy Loss](https://rdipietro.github.io/friendly-intro-to-cross-entropy-loss/) by Rob DiPietro
- [How to Implement a Neural Network Intermezzo 2](https://peterroelants.github.io/posts/cross-entropy-softmax/) by Peter Roelants
- [画像分類の基礎](https://towardsdatascience.com/simply-deep-learning-an-effortless-introduction-45591a1c4abb))

- [Introduction to Convolutional Neural Networks](https://web.stanford.edu/class/cs231a/lectures/intro_cnn.pdf) by Jianxin Wu 
- Yann LeCun’s original article, [Gradient-Based Learning Applied to Document Recognition](http://yann.lecun.com/exdb/publis/pdf/lecun-01a.pdf)
- [The Nine Deep Learning Papers You Need to Know About](https://adeshpande3.github.io/The-9-Deep-Learning-Papers-You-Need-To-Know-About.html) (Understanding CNNs part 3) by Adit Deshpande
