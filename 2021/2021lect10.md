...
- [本日の課題 <img src="../assets/colab_icon.svg">](https://colab.research.google.com/github/komazawa-deep-learning/komazawa-deep-learning.github.io/blob/master/notebooks/2020_0626homework.ipynb){target="_blank"}

# 実習
- [word2vecの先週の再録 <img src="../assets/colab_icon.svg">](https://colab.research.google.com/github/komazawa-deep-learning/komazawa-deep-learning.github.io/blob/master/notebooks/2020_0619word2vec.ipynb){target="_blank"}
...
- [日本語 BERT の実習 <img src="../assets/colab_icon.svg">](https://colab.research.google.com/github/komazawa-deep-learning/komazawa-deep-learning.github.io/blob/master/notebooks/2020_0624BERTja_test.ipynb){target="_blank"}
...
![From [@2014Sutskever_Sequence_to_Sequence]](assets/2014Sutskever_S22_Fig1.svg){style="width"99%"}<br />
...
![](assets/2014Sutskever_Fig2left.svg){style="width:88%"}<br />
From [@2014Sutskever_Sequence_to_Sequence] Fig. 2
</center>

<center>

![](assets/2014Sutskever_Fig2right.svg){style="width:88%"}<br />
From [@2014Sutskever_Sequence_to_Sequence] Fig. 2 
</center>
...
![](assets/ModalNet-19.png){style="width:15%"}<!--<br/>-->
&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;
![](assets/2019Ramachandran_fig3.jpg){style="width:49%"}<br/>
...
![](assets/2017Vaswani_Fig1.svg){style="width:37%"}<br/>
...
![](assets/2018Devlin_BERT_Fig3.svg){style="width:88%"}<br/>
From [@2018BERT] Fig.3
</center>
...
![](assets/mt-dnn.png){style="width:66%"}<br/>
...
![](assets/2019Lample_Fig1.svg){style="width:88%"}<br/>
...
![](assets/2019Rajasekharan_conver.png){style="width:54%"}<br/>
...
![](assets/2019Devlin_mask_method21.jpg){style="width:66%"}<br/>
...
<center>
![](assets/2019Devlin_model_size20.jpg){style="width:59%"}<br/>
モデルのパラメータ数による性能比較
</center>
...
<center>
![](assets/2019Devlin_directionality19.jpg){style="width:59%"}<br/>
言語モデルの相違による性能比較
</center>
...
<center>
![](assets/2019Devlin_Effect_of_Pretraining18.jpg){style="width:59%"}<br/>
事前訓練の効果比較
</center>
...
![](assets/2019hewitt-header.jpg){style="width:39%"}
&nbsp;&nbsp;
...
<center>
![](assets/2015Greff_LSTM_ja.svg){style="width:54%"}
&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;
