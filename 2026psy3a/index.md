...
- [第 01 回 04月17日](2026psyIIIa_lect01){:target="_blank"}: 導入：課題を「測定装置」として捉える視点，計算モデル（情報処理モデル）の基本，授業全体の構成と評価の説明。
- [第 02 回 04月24日](2026psyIIIa_lect02){:target="_blank"}: 行動指標の基礎：反応時間・正答率・誤反応の読み方，平均とばらつき，外れ値の扱い（概念的理解）。
- [第 03 回 05月01日](2026psyIIIa_lect03){:target="_blank"}: モデル化の最小形：下位過程分解（入力→表象→出力）と，競合・選択の基本概念。
- [第 04 回 05月08日](2026psyIIIa_lect04){:target="_blank"}: コンフリクト課題（1）：Stroop 課題のモデル化。一致／不一致条件，遅延と誤答の解釈，予測の立て方。
- [第 05 回 05月15日](2026psyIIIa_lect05){:target="_blank"}: コンフリクト課題（2）：Simon／Flanker課題のモデル化。競合の種類（刺激競合とS-R競合）と Stroop 課題との比較。
- [第 06 回 05月22日](2025psyIIIa_lect06){:target="_blank"}: 視覚探索課題のモデル化：探索戦略，セットサイズ効果，見落としの分類。BIT への接続（探索・偏り）。
- [第 07 回 05月29日](2026psyIIIa_lect07){:target="_blank"}: 語彙判断課題のモデル化：頻度・語長・類似語，語彙アクセスの基礎。WABの言語課題への接続。
- [第 08 回 06月05日](2026psyIIIa_lect08){:target="_blank"}: 言語課題の下位過程分解：単語音読／単語復唱，物品呼称，文章理解の違いを「入力→表象→出力」で整理する。
- 06 月 12 日は休講
- [第 09 回 06月19日](2026psyIIIa_lect09){:target="_blank"}: BIT（1）：線分二等分課題のモデル化（実データを用いる）。偏位の定義，誤りの型，注意バイアス／表象歪みとしての説明。
- [第 10 回 06月26日](2026psyIIIa_lect10){:target="_blank"}: BIT（2）：文字抹消課題のモデル化（実データを用いる）。探索，見落とし，再探索，誤り分類と指標化。
- [第 11 回 07月03日](2026psyIIIa_lect11){:target="_blank"}: WAB（1）：単語音読／単語復唱のモデル化（実データを用いる）。成績パターンと誤反応分類（音韻性・意味性等），下位過程仮説。
- [第 12 回 07月10日](2026psyIIIa_lect12){:target="_blank"}: 意味表象の導入：word2vec 等による意味ベクトル，意味距離と近傍。意味性誤反応（意味性錯読・意味性誤呼称）を説明する補助指標としての位置づけ。
- [第 13 回 07月17日](2026psyIIIa_lect13){:target="_blank"}: 内容WAB（2）：物品呼称／文章理解のモデル化（実データを用いる）。呼称（語彙アクセス）と理解（統合）の分解。意味表象を用いた誤反応の偏り（意味近傍への誤反応等）の検討。
