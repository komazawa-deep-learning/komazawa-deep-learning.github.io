...
- [第 03 回 05月01日](2026psy3a_lect03){:target="_blank"}: Simon 課題<!--モデル化の最小形：下位過程分解（入力→表象→出力）と，競合・選択の基本概念。-->
- [第 04 回 05月08日](2026psy3a_lect04){:target="_blank"}: Stroop 課題<!--コンフリクト課題（1）：Stroop 課題のモデル化。一致／不一致条件，遅延と誤答の解釈，予測の立て方。-->
- [第 05 回 05月15日](2026psy3a_lect05){:target="_blank"}: Flanker 課題<!--コンフリクト課題（2）：Simon／Flanker課題のモデル化。競合の種類（刺激競合とS-R競合）と Stroop 課題との比較。-->
- [第 06 回 05月22日](2026psy3a_lect06){:target="_blank"}: 視覚探索課題のモデル化：探索戦略，セットサイズ効果，見落としの分類。BIT への接続（探索・偏り）。
- [第 07 回 05月29日](2026psy3a_lect07){:target="_blank"}: 相互活性化モデル
- [第 08 回 06月05日](2026psy3a_lect08){:target="_blank"}: 語彙判断課題のモデル化：頻度・語長・類似語，語彙アクセスの基礎。WABの言語課題への接続。言語課題の下位過程分解：単語音読／単語復唱，物品呼称，文章理解の違いを「入力→表象→出力」で整理する。
- 06 月 12 日は休講
